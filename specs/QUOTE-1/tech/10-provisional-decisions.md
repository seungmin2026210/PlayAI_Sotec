...
| open-9 | 기술 스택 | React+TS / FastAPI / PostgreSQL | [01-stack-and-setup.md](./01-stack-and-setup.md) |
| open-10 | 수정 상세 범위 | 전체 필드 / 상태 유지 / 감사로그 미기록 | `backend services/status.py: apply_edit_policy` |
| open-11 | 999 초과 / 동시성 | 초과 시 409 차단, `FOR UPDATE`+`UNIQUE` | `backend services/numbering.py: allocate` |
